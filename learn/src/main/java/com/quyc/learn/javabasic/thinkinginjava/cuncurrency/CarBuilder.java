package com.quyc.learn.javabasic.thinkinginjava.cuncurrency;//: concurrency/CarBuilder.java
    ...
    public void run() {
        try {
            while (!Thread.interrupted()) {
                ...
                // Put car3 into finishingQueue for further work
